        ...
        <div class="contact-form">
            <form method="POST" action="{{ route('histoires.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="titre" class="form-control" placeholder="titre de l'histoire" required value="{{old('titre')}}">
                </div>
                <div class="form-group">
                    <label for="photo">Photo</label>
                    <input type="text" name="photo" class="form-control" placeholder="photo de l'histoire" required value="{{old('photo')}}">
                </div>
                <div class="form-group">
                    <label for="pitch">Pitch de l'histoire</label>
                    <textarea cols="30" rows="10" name="pitch" class="form-control" placeholder="résumé de l'histoire" required></textarea>
                </div>
                    {{old('pitch')}}
                <div class="form-group">
